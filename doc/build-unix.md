...
memory available when compiling Hypercoin Core. With 512MB of memory or less
...
# Pick some path to install BDB to, here we create a directory within the hypercoin directory
BDB_PREFIX="${HYPERCOIN_ROOT}/db4"
mkdir -p $BDB_PREFIX
...
# Configure Hypercoin Core to use our own-built instance of BDB
cd $HYPERCOIN_ROOT
