    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Hypercoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Hypercoin Core"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Hypercoin Core is shutting down...") + "<br /><br />" +
