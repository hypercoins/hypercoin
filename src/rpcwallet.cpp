...
Value setaccount(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("setaccount", "\"HTPcfmSU1CKMC6MrsKT1tmEHw7nEc8DGqG\" \"tabby\"")
            + HelpExampleRpc("setaccount", "\"HTPcfmSU1CKMC6MrsKT1tmEHw7nEc8DGqG\", \"tabby\"")
        );
...
Value getaccount(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("getaccount", "\"HTPcfmSU1CKMC6MrsKT1tmEHw7nEc8DGqG\"")
            + HelpExampleRpc("getaccount", "\"HTPcfmSU1CKMC6MrsKT1tmEHw7nEc8DGqG\"")
        );
...
Value sendtoaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"HTPcfmSU1CKMC6MrsKT1tmEHw7nEc8DGqG\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"HTPcfmSU1CKMC6MrsKT1tmEHw7nEc8DGqG\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleRpc("sendtoaddress", "\"HTPcfmSU1CKMC6MrsKT1tmEHw7nEc8DGqG\", 0.1, \"donation\", \"seans outpost\"")
        );
...
Value signmessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            + HelpExampleCli("signmessage", "\"HTPcfmSU1CKMC6MrsKT1tmEHw7nEc8DGqG\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"HTPcfmSU1CKMC6MrsKT1tmEHw7nEc8DGqG\" \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("signmessage", "\"HTPcfmSU1CKMC6MrsKT1tmEHw7nEc8DGqG\", \"my message\"")
        );
...
Value getreceivedbyaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            + HelpExampleCli("getreceivedbyaddress", "\"HTPcfmSU1CKMC6MrsKT1tmEHw7nEc8DGqG\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"HTPcfmSU1CKMC6MrsKT1tmEHw7nEc8DGqG\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n"
            + HelpExampleCli("getreceivedbyaddress", "\"HTPcfmSU1CKMC6MrsKT1tmEHw7nEc8DGqG\" 6") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("getreceivedbyaddress", "\"HTPcfmSU1CKMC6MrsKT1tmEHw7nEc8DGqG\", 6")
       );
...
Value sendfrom(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 3 || params.size() > 6)
        throw runtime_error(
            ...
            + HelpExampleCli("sendfrom", "\"\" \"HTPcfmSU1CKMC6MrsKT1tmEHw7nEc8DGqG\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" \"HTPcfmSU1CKMC6MrsKT1tmEHw7nEc8DGqG\" 0.01 6 \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"HTPcfmSU1CKMC6MrsKT1tmEHw7nEc8DGqG\", 0.01, 6, \"donation\", \"seans outpost\"")
        );
...
Value sendmany(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw runtime_error(
            ...
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"HTPcfmSU1CKMC6MrsKT1tmEHw7nEc8DGqG\\\":0.01,\\\"LbhhnRHHVfP1eUJp1tDNiyeeVsNhFN9Fcw\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"HTPcfmSU1CKMC6MrsKT1tmEHw7nEc8DGqG\\\":0.01,\\\"LbhhnRHHVfP1eUJp1tDNiyeeVsNhFN9Fcw\\\":0.02}\" 6 \"testing\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"tabby\", \"{\\\"HTPcfmSU1CKMC6MrsKT1tmEHw7nEc8DGqG\\\":0.01,\\\"LbhhnRHHVfP1eUJp1tDNiyeeVsNhFN9Fcw\\\":0.02}\", 6, \"testing\"")
        );
...
Value addmultisigaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
    {
        string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
            ...
            + HelpExampleCli("addmultisigaddress", "2 \"[\\\"HTPcfmSU1CKMC6MrsKT1tmEHw7nEc8DGqG\\\",\\\"LbhhnRHHVfP1eUJp1tDNiyeeVsNhFN9Fcw\\\"]\"") +
            "\nAs json rpc call\n"
            + HelpExampleRpc("addmultisigaddress", "2, \"[\\\"HTPcfmSU1CKMC6MrsKT1tmEHw7nEc8DGqG\\\",\\\"LbhhnRHHVfP1eUJp1tDNiyeeVsNhFN9Fcw\\\"]\"")
        ;
...
Value walletlock(const Array& params, bool fHelp)
{
    if (pwalletMain->IsCrypted() && (fHelp || params.size() != 0))
        throw runtime_error(
            ...
            + HelpExampleCli("sendtoaddress", "\"HTPcfmSU1CKMC6MrsKT1tmEHw7nEc8DGqG\" 1.0") +
...
Value encryptwallet(const Array& params, bool fHelp)
{
    if (!pwalletMain->IsCrypted() && (fHelp || params.size() != 1))
        throw runtime_error(
            ...
            + HelpExampleCli("signmessage", "\"hypercoinaddress\" \"test message\"") +
